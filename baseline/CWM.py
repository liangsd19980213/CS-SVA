...
# Load datasets
train_df = pd.read_csv('../dataset/processed_data_original/train_data.csv')
test_df = pd.read_csv('../dataset/processed_data_original/test_data.csv')
valid_df = pd.read_csv('../dataset/processed_data_original/val_data.csv')

# Define features and labels
X_train = train_df['func_before'].values
X_test = test_df['func_before'].values
X_valid = valid_df['func_before'].values

# Define labels
y_train = train_df['severity'].values
y_test = test_df['severity'].values
y_valid = valid_df['severity'].values
